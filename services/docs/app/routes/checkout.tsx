  ...
  return (
    <div>
      ...
      <section className="mb-10">
        ...
        <p className="mb-3">
          Start by creating an empty cart. Specify the currency and an optional
...
await tipAgent.com.atiproto.feed.tip.create({
  ...
  recordUri: "at://did:plc:creator456/app.bsky.feed.post/abc123",
        ...
        <p className="mb-3">
          Once the cart is ready, redirect the user to the{" "}
          <code className="px-1.5 py-0.5 bg-surface-alt dark:bg-surface-alt-dark rounded text-sm font-mono">
            checkoutUrl
          </code>
          . This takes them to atiproto's hosted checkout page where they
          complete payment via Stripe.
        </p>
        <CodeBlock
          code={`// Redirect the user to complete payment
window.location.href = checkoutUrl;`}
      ...
      <section className="mb-10">
        ...
        <p className="mb-3">
          ...
          , a new cart is automatically created and the{" "}
          <code className="px-1.5 py-0.5 bg-surface-alt dark:bg-surface-alt-dark rounded text-sm font-mono">
            checkoutUrl
          </code>{" "}
