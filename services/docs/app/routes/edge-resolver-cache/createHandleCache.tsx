...
export default function CreateHandleCachePage() {
  return (
    <div>
      <h1 className="text-2xl font-bold mb-1">createHandleCache</h1>
      ...
      <p className="text-text-muted dark:text-text-muted-dark mb-8">
        ...
        for caching ATProto handle resolution results. L1 is an in-memory LRU
        cache; L2 is a{" "}
        <a
      ...
      <section className="mb-10">
        ...
        <CodeBlock
          code={`function createHandleCache(options?: CreateHandleCacheOptions): TieredStore<string, AtprotoDid | null>`}
        />
        ...
        <div className="overflow-x-auto mt-4">
          <table className="w-full text-sm border border-border dark:border-border-dark">
            ...
            <tbody className="text-text-muted dark:text-text-muted-dark">
              ...
              <tr className="border-b border-border dark:border-border-dark">
                <td className="px-3 py-2 font-mono text-xs">l1MaxEntries</td>
                <td className="px-3 py-2 font-mono text-xs">number</td>
                <td className="px-3 py-2 font-mono text-xs">1000</td>
                <td className="px-3 py-2 text-xs">
              ...
              <tr className="border-b border-border dark:border-border-dark">
                ...
                <td className="px-3 py-2 font-mono text-xs">number</td>
                <td className="px-3 py-2 font-mono text-xs">600_000 (10min)</td>
                <td className="px-3 py-2 text-xs">
              ...
              <tr>
                ...
                <td className="px-3 py-2 font-mono text-xs">number</td>
                <td className="px-3 py-2 font-mono text-xs">3600 (1hr)</td>
                <td className="px-3 py-2 text-xs">
      ...
      <section className="mb-10">
        ...
        <CodeBlock
          code={`import { createHandleCache } from "@atiproto/edge-resolver-cache";
import { EdgeOAuthClient } from "@atiproto/edge-oauth-client";

const client = new EdgeOAuthClient({
  // ...
  handleCache: createHandleCache({ cacheName: "my-cache" }),
});`}
        />
      </section>
        ...
        <ul className="space-y-1 text-sm">
          <li>
            ...
            <span className="text-text-muted dark:text-text-muted-dark">
              — equivalent factory for DID document caching
            </span>
          </li>
          <li>
            <a
