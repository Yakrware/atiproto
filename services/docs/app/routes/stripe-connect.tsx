    ...
    <div>
      ...
      <section className="mb-10">
        ...
        <p className="mb-3">
          ...
          field indicates whether their account is fully set up to receive
          payments.
        </p>
        <CodeBlock
...
if (!data.readyForPayment) {
  ...
  redirectToConnect();
      ...
      <section className="mb-10">
        ...
        <p className="mb-3">
          When a user is not connected to Stripe, send them to the atiproto
          connect page. This handles the full Stripe Connect onboarding flow
          including identity verification and bank account setup.
        </p>
        <CodeBlock
          code={`function redirectToConnect() {
  ...
  window.location.href = "https://atiproto.com/connect";
        ...
        <p className="mt-3 text-sm text-text-muted dark:text-text-muted-dark">
          After completing the Stripe onboarding, the user is redirected back to
          your application. Their{" "}
          <code className="px-1.5 py-0.5 bg-surface-alt dark:bg-surface-alt-dark rounded text-sm font-mono">
            readyForPayment
          </code>{" "}
      ...
      <section className="mb-10">
        ...
        <p className="mb-3">
          Here's a complete flow for checking a creator's payment status and
          prompting them to connect if needed:
        </p>
        <CodeBlock
